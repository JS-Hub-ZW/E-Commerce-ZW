...
/* Blog Routes */
router.get('/blog/:id', BlogController.getProduct);
router.get('/blogs', BlogController.settings);
...
/* SEO Routes */
router.get('/seo/:page_num', SEOController.getProduct);
router.get('/all-seo', SEOController.settings);
